...
def getListPositions(chars):
    ...
    if(length == 3):
        ...
        positionsList.append([2290, 710, chars[0], False])
        positionsList.append([2190, 765, chars[1], False])
        positionsList.append([2200, 875, chars[2], False])
        positionsList.append([2290, 925, chars[3], False])
        positionsList.append([2385, 870, chars[4], False])
        positionsList.append([2385, 765, chars[5], False])
...
def makeMoviment(word, positions):
    ...
    for firstChar in positions:
        if (firstChar[2] == word[0]):
            pyautogui.moveTo(firstChar[0], firstChar[1])
            time.sleep(0.1)
